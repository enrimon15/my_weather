...
class HomeLayoutType extends StatefulWidget {
  @override
  _HomeLayoutTypeState createState() => _HomeLayoutTypeState();
}

class _HomeLayoutTypeState extends State<HomeLayoutType> {
